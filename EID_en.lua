local ItemID = {
    Id1 = Isaac.GetItemIdByName("幸运十字架"),--幸运十字架
    Id2 = Isaac.GetItemIdByName("红月亮"),--红月亮
    Id3 = Isaac.GetItemIdByName("小虎鲸"),--小虎鲸
    Id4 = Isaac.GetItemIdByName("时空包裹"),--时空包裹
    Id5 = Isaac.GetItemIdByName("甸伊"),--甸伊
    Id6 = Isaac.GetItemIdByName("恶之硫火"),--恶之硫火
    Id7 = Isaac.GetItemIdByName("大冒险！"),--大冒险！
    Id8 = Isaac.GetItemIdByName("粪球"),--粪球
    Id9 = Isaac.GetItemIdByName("乞丐帮主令牌"),--乞丐帮主的令牌
    Id10 = Isaac.GetItemIdByName("可爱宠物"),--可爱宠物
    Id11 = Isaac.GetItemIdByName("噩梦与美梦"),--噩梦与美梦
    Id12 = Isaac.GetItemIdByName("土豆"),--土豆
    Id13 = Isaac.GetItemIdByName("12"),--12
    Id14 = Isaac.GetItemIdByName("碎裂的R键"),--碎裂的R键
    Id15 = Isaac.GetItemIdByName("保送书"),--保送书
    Id16 = Isaac.GetItemIdByName("101%"),--101%
    Id17 = Isaac.GetItemIdByName("婴儿车"),--婴儿车
...
if  EID then 
    ...
    EID:addCollectible(ItemID.Id3,'{{ColorOrange}}Trigger {{Collectible628}} death certificate effect#Each new floor will grant a curse#When holding this item, reduce 1 {{Heart}} heart container per floor!!!#{{ColorYellow}}Two-time use{{CR}}','{{ColorOrange}}Baby Orca{{CR}}','en_us')--第3个道具(主动)
    ...
    EID:addCollectible(ItemID.Id5,'Using the card and pill triggers all dice effects and grants 2 random items','{{ColorGray}}Eden{{CR}}','en_us')--第5个道具(被动)
    ...
    EID:addCollectible(ItemID.Id8,'At the beginning of each floor, 2 {{SoulHeart}} soul hearts are spawn, and a whole room fills with poops.#Using pills will flush away non-boss enemies','Poop ball','en_us')--第8个道具(被动)
    ...
    EID:addCollectible(ItemID.Id16,'Entering a new room with items / pickups inside, quadruples it','101%','en_us')
    ...
    EID:addCollectible(ItemID.Id20,'Entering a new floor, remove all items','Envy','en_us')
    ...
    EID:addCollectible(ItemID.Id25,"After obtaining, start teleporting to the Boss room on each floor, starting from the next level#Change pickups in the new room into blue flies or blue spider#Because I don't want to move",'Sloth','en_us')
    ...
    EID:addCollectible(ItemID.Id29,'Entering a new room, shouts aggressively and increase fire rate#↑ +2 Health','Taurus (Modified)','en_us')
    ...
    EID:addCollectible(ItemID.Id35,'Turns all items to glitched itmes#Glitched items cannot be glitched again#After use, it turns into a pocket active item#{{ColorYellow}}One time use！{{CR}}','Error D4','en_us')
